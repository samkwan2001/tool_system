...
CREATE TABLE `workplace` (
  `workPlaceID` char(6) NOT NULL,
  `workPlace_tableColour` char(50) DEFAULT NULL,
...
INSERT INTO `workplace` VALUES ('000000','black'),('0000ff','blue'),('ff0000','red'),('ffff00','yellow'),('ffffff','white');
